...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        my_list = ["Авиационная промышленность",
                   ...
                   "Производство бытовой элестроники и эектрических приборов",
                   "Производство ж/д транспорта",
                   "Производство кокса и нефтепродуктов",
                   "Производство напитков",
                   "Производство оружия, боеприпасов, спецхимии, военных машин",
                   "Производство прочих товаров народного потребленя",
        ...
        for item in my_list:
            Branch.objects.create(name=item)